...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mContactsListFragment = (ContactsListFragment) fm
                .findFragmentById(R.id.contacts_list_fragment);
        if (mContactsListFragment == null) {
            mContactsListFragment = new ContactsListFragment();
            FragmentTransaction transaction = fm.beginTransaction();
            transaction.add(R.id.contacts_list_fragment, mContactsListFragment);
            transaction.commit();
        }
    }
